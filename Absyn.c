...
RegraBlocoVar make_RegraBlocoVar3(ListaIdent p1, RegraTipo p2)
{
    RegraBlocoVar tmp = (RegraBlocoVar) malloc(sizeof(*tmp));
    if (!tmp)
    {
        fprintf(stderr, "Error: out of memory when allocating RegraBlocoVar3!\n");
        exit(1);
    }
    tmp->kind = is_RegraBlocoVar3;
    tmp->u.regrablocovar3_.listaident_ = p1;
    tmp->u.regrablocovar3_.regratipo_ = p2;
    return tmp;
}

/********************   RegraBlocoVar4    ********************/

RegraBlocoVar make_RegraBlocoVar4(ListaIdent p1, RegraTipo p2, RegraBlocoVar p3)
{
    RegraBlocoVar tmp = (RegraBlocoVar) malloc(sizeof(*tmp));
    if (!tmp)
    {
        fprintf(stderr, "Error: out of memory when allocating RegraBlocoVar4!\n");
        exit(1);
    }
    tmp->kind = is_RegraBlocoVar4;
    tmp->u.regrablocovar4_.listaident_ = p1;
    tmp->u.regrablocovar4_.regratipo_ = p2;
    tmp->u.regrablocovar4_.regrablocovar_ = p3;
    return tmp;
}
...
Atribuicao make_Atribuicao2(Ident p1, Ident p2)
{
    Atribuicao tmp = (Atribuicao) malloc(sizeof(*tmp));
    if (!tmp)
    {
    ...
    tmp->u.atribuicao2_.ident_1 = p1;
    tmp->u.atribuicao2_.ident_2 = p2;
    return tmp;
}

/********************   Atribuicao3    ********************/

Atribuicao make_Atribuicao3(Ident p1, SubEscrito p2, Valor p3)
{
    Atribuicao tmp = (Atribuicao) malloc(sizeof(*tmp));
    if (!tmp)
    {
    ...
    tmp->u.atribuicao3_.subescrito_ = p2;
    tmp->u.atribuicao3_.valor_ = p3;
    return tmp;
}

/********************   Atribuicao4    ********************/

Atribuicao make_Atribuicao4(Ident p1, Valor p2)
{
    Atribuicao tmp = (Atribuicao) malloc(sizeof(*tmp));
    if (!tmp)
    {
        fprintf(stderr, "Error: out of memory when allocating Atribuicao4!\n");
        exit(1);
    }
    tmp->kind = is_Atribuicao4;
    tmp->u.atribuicao4_.ident_ = p1;
    tmp->u.atribuicao4_.valor_ = p2;
    return tmp;
}
...
Atribuicao make_Atribuicao5(Ident p1, ChamadaFuncaoEProc p2)
{
    ...
    if (!tmp)
    {
        fprintf(stderr, "Error: out of memory when allocating Atribuicao5!\n");
        exit(1);
    }
...
ChamadaFuncaoEProc make_L33(Ident p1, ListaIdent p2)
{
    ...
    tmp->kind = is_L33;
    tmp->u.l33_.ident_ = p1;
    tmp->u.l33_.listaident_ = p2;
    return tmp;
}

/********************   ListaIdentIdent    ********************/

ListaIdent make_ListaIdentIdent(Ident p1)
{
    ListaIdent tmp = (ListaIdent) malloc(sizeof(*tmp));
    if (!tmp)
    {
        fprintf(stderr, "Error: out of memory when allocating ListaIdentIdent!\n");
        exit(1);
    }
    tmp->kind = is_ListaIdentIdent;
    tmp->u.listaidentident_.ident_ = p1;
    return tmp;
}

/********************   ListaIdent1    ********************/

ListaIdent make_ListaIdent1(Ident p1, ListaIdent p2)
{
    ListaIdent tmp = (ListaIdent) malloc(sizeof(*tmp));
    if (!tmp)
    {
        fprintf(stderr, "Error: out of memory when allocating ListaIdent1!\n");
        exit(1);
    }
    tmp->kind = is_ListaIdent1;
    tmp->u.listaident1_.ident_ = p1;
    tmp->u.listaident1_.listaident_ = p2;
    return tmp;
}
...
RegraBlocoVar clone_RegraBlocoVar(RegraBlocoVar p)
{
  ...
  case is_RegraBlocoVar3:
    return make_RegraBlocoVar3
      ( clone_ListaIdent(p->u.regrablocovar3_.listaident_)
      , clone_RegraTipo(p->u.regrablocovar3_.regratipo_)
      );

  case is_RegraBlocoVar4:
    return make_RegraBlocoVar4
      ( clone_ListaIdent(p->u.regrablocovar4_.listaident_)
      , clone_RegraTipo(p->u.regrablocovar4_.regratipo_)
      , clone_RegraBlocoVar(p->u.regrablocovar4_.regrablocovar_)
      );
...
Atribuicao clone_Atribuicao(Atribuicao p)
{
  ...
  case is_Atribuicao2:
    return make_Atribuicao2
      ( strdup(p->u.atribuicao2_.ident_1)
      , strdup(p->u.atribuicao2_.ident_2)
      );

  case is_Atribuicao3:
    return make_Atribuicao3
      ( strdup(p->u.atribuicao3_.ident_)
      , clone_SubEscrito(p->u.atribuicao3_.subescrito_)
      , clone_Valor(p->u.atribuicao3_.valor_)
      );

  case is_Atribuicao4:
    return make_Atribuicao4
      ( strdup(p->u.atribuicao4_.ident_)
      , clone_Valor(p->u.atribuicao4_.valor_)
      );
...
ChamadaFuncaoEProc clone_ChamadaFuncaoEProc(ChamadaFuncaoEProc p)
{
  ...
  case is_L33:
    return make_L33
      ( strdup(p->u.l33_.ident_)
      , clone_ListaIdent(p->u.l33_.listaident_)
      );
...
ListaIdent clone_ListaIdent(ListaIdent p)
{
  ...
  case is_ListaIdentIdent:
    return make_ListaIdentIdent (strdup(p->u.listaidentident_.ident_));

  case is_ListaIdent1:
    return make_ListaIdent1
      ( strdup(p->u.listaident1_.ident_)
      , clone_ListaIdent(p->u.listaident1_.listaident_)
      );

  default:
    fprintf(stderr, "Error: bad kind field when cloning ListaIdent!\n");
    exit(1);
  }
}
...
void free_RegraBlocoVar(RegraBlocoVar p)
{
  ...
  case is_RegraBlocoVar3:
    free_ListaIdent(p->u.regrablocovar3_.listaident_);
    free_RegraTipo(p->u.regrablocovar3_.regratipo_);
    break;

  case is_RegraBlocoVar4:
    free_ListaIdent(p->u.regrablocovar4_.listaident_);
    free_RegraTipo(p->u.regrablocovar4_.regratipo_);
    free_RegraBlocoVar(p->u.regrablocovar4_.regrablocovar_);
    break;
...
void free_Atribuicao(Atribuicao p)
{
  ...
  case is_Atribuicao2:
    free(p->u.atribuicao2_.ident_1);
    free(p->u.atribuicao2_.ident_2);
    break;

  case is_Atribuicao3:
    free(p->u.atribuicao3_.ident_);
    free_SubEscrito(p->u.atribuicao3_.subescrito_);
    free_Valor(p->u.atribuicao3_.valor_);
    break;

  case is_Atribuicao4:
    free(p->u.atribuicao4_.ident_);
    free_Valor(p->u.atribuicao4_.valor_);
    break;
...
void free_ChamadaFuncaoEProc(ChamadaFuncaoEProc p)
{
  ...
  {
  case is_L33:
    free(p->u.l33_.ident_);
    free_ListaIdent(p->u.l33_.listaident_);
    break;
...
void free_ListaIdent(ListaIdent p)
{
  ...
  {
  case is_ListaIdentIdent:
    free(p->u.listaidentident_.ident_);
    break;

  case is_ListaIdent1:
    free(p->u.listaident1_.ident_);
    free_ListaIdent(p->u.listaident1_.listaident_);
    break;

  default:
    fprintf(stderr, "Error: bad kind field when freeing ListaIdent!\n");
    exit(1);
  }
  free(p);
}
